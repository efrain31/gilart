    ...
    val builder = NotificationCompat.Builder(
        ...
        .setStyle(
            NotificationCompat
                ...
                .setBigContentTitle("Creart catalogo digital")
        )
        .setPriority(priority)
        .setContentIntent(pendingIntent)
        .setAutoCancel(true)
    ...
    */
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
        if (alarmManager.canScheduleExactAlarms()) {
            // Programar la alarma si se tiene el permiso
            ...
            // Pedir permiso para programar alarmas exactas
            val intent = Intent(Settings.ACTION_REQUEST_SCHEDULE_EXACT_ALARM)
            context.startActivity(intent)
        }
    } else {
        // Programar la alarma en versiones anteriores a Android 12
        alarmManager.setExact(
            AlarmManager.RTC_WAKEUP,
            Calendar.getInstance().timeInMillis + 10000,
            pendingIntent
